...
StompConnection.prototype.handleSubscribe = function (frame) {
  ...
  var type = matches[2]
  var serviceId = this.server.topicMap[topicId]['serviceId']
  if (!serviceId) {
  ...
  this.server.addSubscription(this, topicId, type)
  ...
  this.sendMessage(topic, serviceId, type)
}

StompConnection.prototype.sendMessage = function (topic, serviceId, type) {
